...
vtkSmartPointer<myParametricFigure8Torus> figure8Torus = vtkSmartPointer<myParametricFigure8Torus>::New();
  figure8Torus->SetRadius(1.0);
#ifdef NO_DERIVATIVES
  figure8Torus->DerivativesAvailableOff();
#endif

vtkSmartPointer<vtkParametricFunctionSource> pfnSrc = vtkSmartPointer<vtkParametricFunctionSource>::New();
  pfnSrc->SetParametricFunction(figure8Torus);
...
#endif
#ifdef NO_DERIVATIVES
  imgWriter->SetFileName("Figure8TorusNoDerivaives.png");
#else
  imgWriter->SetFileName("Figure8Torus.png");
#endif
  imgWriter->Write();
